---
title: Variables
description: Variables in k0nfig are a powerful feature that allows you to store user inputs, selections, or values read from files, and then reuse them throughout your configuration. Variables are declared with a dollar sign prefix ($) and are referenced using the same syntax.s
---
