...
const commands = [
  { id: '1', text: `curl -X GET "${endpoint}" | jq`, typing: true, delay: 50, clear: false },
  ...
  { id: '6', text: `npx kmdrr@latest run ${endpoint}`, typing: true, delay: 50, clear: false },
  { id: '7', text: 'Running command...', typing: false, delay: 50, clear: false },
  { id: '8', text: '', typing: true, delay: 1000, clear: false },
  { id: '9', text: 'Added /assets/db/turso/index.ts to ~/db/index.ts', typing: false, delay: 1000, clear: false },
  { id: '10', text: 'Dependencies installed', typing: false, delay: 1000, clear: false },
  { id: '11', text: 'Updated db.engine in setup.json to sqlite', typing: false, delay: 1000, clear: false },
];
...
export function DemoSection() {
  ...
  return (<section className="flex flex-col w-full md:flex-row gap-4 pt-8">
    <Card className="flex-grow min-h-[500px] overflow-hidden">
      <AppHeader appName="Terminal" />
      <div className="w-full h-full p-2 overflow-y-auto">
        <CLISimulator key={String(key)} commands={commands} defaultDelay={100} onNextCommand={(item) => {
...
function AppHeader({ appName }: { appName: string }) {
  return (<div className="bg-muted h-6 rounded-t flex items-center border-b px-2 gap-2 relative">
