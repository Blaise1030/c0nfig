...
export default function Home() {
  return (
    <div className="flex flex-col py-8 gap-2">
      ...
      <svg
        className="absolute inset-0 -z-10 h-full w-full stroke-border/50 dark:stroke-border/70 [mask-image:radial-gradient(100%_100%_at_center_center,white,transparent)]"
        aria-hidden="true"
      >
        <defs>
          <pattern
